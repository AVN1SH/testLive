...
const CallToAction = () => {
  return (
    <div className="bg-slate-200 rounded w-[calc(100%-20px)] ml-2 p-2 mt-5">
      <div className="font-semibold text-2xl text-slate-700 bg-white rounded p-2 w-fit shadow-md">Ready to Start Your Journey?<span className="divider-vertical border-solid border-[1px] border-orange-300 mx-2"></span><span className="font-thin text-md">Apply now or contact us for more information.</span>
      </div>
