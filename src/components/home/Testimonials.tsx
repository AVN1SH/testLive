...
const Testimonials = () => {
  ...
  return (
    <div className="bg-slate-200 rounded w-[calc(100%-20px)] ml-2 p-2 mt-5">
      <div className="">
        <div className="font-semibold text-2xl text-slate-700 bg-white mb-2 rounded p-2 w-full shadow-md"> Testimonials<span className="divider-vertical border-solid border-[1px] border-orange-300 mx-2"></span><span className="font-thin text-md">What Our Student Say.</span>
        </div>
